...
func main() {
	fmt.Printf("Добро пожаловать! Введите  выражение:\n")
...
var errorDict = map[int]string{
	...
	3: "Для работы калькулятора необходимо два числа и математический оператор",
	4: "Нельзя делить на ноль!",
	5: "Критическая ошибка!",
	6: "Можно выполнить только одно выражение за раз.",
	7: "В римских числах нет отрицательных.",
